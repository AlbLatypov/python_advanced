...
files = ['python.png', 'qwerty.py', 'stepik.png', 'beegeek.org', 'windows.pnp', 'pen.txt', 'phone.py', 
         'book.txT', 'board.pNg', 'keyBoard.jpg', 'Python.PNg', 'apple.jpeg', 'png.png', 'input.tXt', 'split.pop', 'solution.Py', 
         'stepik.org', 'kotlin.ko', 'github.git']

m_set = {words.lower() for words in files if words.lower()[:-4:-1]=='gnp'}
print(*sorted(m_set))

pngs = {el.lower() for el in files if el[-4:].lower() == '.png'}
