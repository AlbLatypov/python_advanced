...
odd_ = list(filter(lambda x: x>47 and x % 2 == 1, numbers))
odd_ = [n for n in numbers if n not in odd_]
do_odd_ = list(map(lambda x:x // 2 if x % 2 == 0 else x, odd_))

print(len(numbers),len(do_odd_))
print(*do_odd_)
