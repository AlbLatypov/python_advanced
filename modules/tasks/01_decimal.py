...
num_t = num.as_tuple().digits
max1 = max(num_t)
min1 = min(num_t) if not str(num).startswith('0') and not str(num).startswith('-0') else 0
print(min1+max1)
...
print(D.exp(num) + D.ln(num) + D.log10(num) + D.sqrt(num))
