...
dct={('бумага', 'камень'):'бумага',
     ...
     ('камень', 'ящерица'):'камень',
     ('Спок', 'ящерица'):'ящерица',
     ('ножницы', 'Спок'):'Спок',
     ('ножницы', 'ящерица'):'ножницы',
     ('бумага', 'ящерица'):'ящерица',
     ('бумага', 'Спок'):'бумага',
     ('камень', 'Спок'):'Спок',
     }
get_result={Tim:'Тимур',Rus:'Руслан'}
result=get_result.get(dct.get(tuple(sorted((Tim,Rus),key=str.lower)),'ничья'),'ничья')
